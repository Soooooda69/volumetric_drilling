...
SENSOR_SIZE = [0.00523, 0.00294] # Zed 1/3'' 16:9
...
if __name__ == '__main__':
    ...
    # stereo parameters
    parser.add_argument('--baseline', type=float, nargs='?', default=0.06305, help='meters') # change baseline
    ...
    parser.add_argument('--clipping_plane', nargs='+', default=[0.01, 50.0], help='[near, far], meters, for accuracy\n'
                                                                                 'set far plane as far as possible')
    parser.add_argument('--res', nargs='+', default=[640, 360], help='image [width, height]')
